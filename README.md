...
Visualized sentiment distributions and compared them against user ratings
Text Analysis
Filtered and analyzed positively rated reviews
Extracted frequently mentioned positive keywords and phrases
Visualized positive terms using word clouds and frequency plots
Data Visualization
Histograms and bar plots to display sentiment trends
Subjectivity distribution plots
Keyword frequency visualizations and word clouds
💡 Key Insights

(Add your specific findings here once analysis is complete — e.g., overall sentiment split, most praised/criticized features, correlation between sentiment and star ratings)
